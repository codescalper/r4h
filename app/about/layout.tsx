...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "From 20 runners at Upvan Lake in 2015 to 2400+ members today. Discover Run4Health's journey and mission to build healthier communities.",
    url: "https://run4health.in/about",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "About Run4Health" }],
  },
  twitter: {
    title: "About Run4Health — Our Story & Mission",
    description:
      "From 20 runners at Upvan Lake in 2015 to 2400+ members today. Learn about Run4Health's journey.",
  },
}
