          ...
          <div className={`${lora.className} space-y-5 text-muted-foreground`}>
            ...
            <div className="flex gap-3 items-center">
              ...
              <div>
                ...
                <p className="text-sm">run4health2026@gmail.com</p>
              </div>
            </div>
          </div>
            ...
            <CardContent className="p-7">
              {sent ? (
                ...
                >
                  ...
                  <p
                    className={`${lora.className} text-sm text-muted-foreground text-center`}
                  >
                ...
                <div className="space-y-4">
                  <h2
                    className={`${bebasNeue.className} text-3xl tracking-wide text-foreground mb-2`}
                  >
                    SEND A MESSAGE
                  </h2>
                  <div>
                  ...
                  {error && (
                    <p className={`${lora.className} text-sm text-destructive`}>
                      {error}
                    </p>
                  )}
                  <Button
