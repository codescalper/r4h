        ...
        >
          <Card className="border-primary/20 bg-primary/5 h-full">
            <CardContent className="p-5 sm:p-8">
              ...
              <blockquote
                className={`${bebasNeue.className} text-2xl sm:text-3xl lg:text-4xl tracking-wide text-foreground leading-tight`}
              >
                &ldquo;Empowering communities toward better health through
                fitness, awareness, and collective action.&rdquo;
              </blockquote>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className={`${bebasNeue.className} tracking-wide text-lg text-foreground`}
                  >
                    Coach Shashi Nair
                  </p>
                  <p
              ...
              <Button
                variant="ghost"
                className="mt-4 gap-1 text-primary pl-0"
            ...
            >
              <Card className="border-border hover:border-primary/40 transition-colors">
                <CardContent className="p-5 flex flex-col gap-2">
                  ...
                  <p
                    className={`${bebasNeue.className} text-3xl tracking-wider text-foreground`}
                  >
                    {s.value}
                  </p>
                  <p
