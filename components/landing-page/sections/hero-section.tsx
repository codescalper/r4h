...
import { ArrowRight, Heart, TrendingUp, Timer, Users, ChevronRight } from "lucide-react"
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute -right-36 top-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full pointer-events-none" style={{ border: "1px solid var(--primary)", opacity: 0.06 }} />
        <div className="absolute -right-52 top-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full pointer-events-none" style={{ border: "1px solid var(--primary)", opacity: 0.03 }} />
        <div className="absolute -right-20 top-1/2 -translate-y-1/2 w-[520px] h-[520px] rounded-full pointer-events-none" style={{ backgroundColor: "var(--primary)", opacity: 0.04, filter: "blur(60px)" }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full grid lg:grid-cols-2 gap-10 lg:gap-14 items-center pt-28 pb-16 sm:pt-32 sm:pb-20">
        ...
        <div>
          ...
          >
            <Button size="lg" onClick={() => navigate("register")} className="gap-2 text-sm sm:text-base px-6 shadow-lg">
        ...
        >
          <div className="relative w-full max-w-sm">
            ...
            <div className="relative bg-card/90 backdrop-blur-md border border-border rounded-3xl p-7 shadow-2xl space-y-5">
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className={`${bebasNeue.className} text-xl tracking-wider text-foreground leading-none`}>
                            {m.value}{" "}
                            <span className={`${lora.className} text-xs text-muted-foreground font-normal tracking-normal`}>{m.unit}</span>
                          </p>
                        </div>
                      </div>
              ...
              <Button size="sm" className="w-full gap-2 shadow-md" onClick={() => navigate("register")}>
